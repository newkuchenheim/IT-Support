...
function init() {
	...
	function sendEmail() {
		...
		// create email parts
		var subject = "Änderungsmitteilung unbezahlter Urlaub ";
		var ccPart = "";
	...
	wtConfig.MainSteps[0].title += "Unbezahlte Urlaub";
	...
	var steps = [
		...
		},
		{
			element: "#step_dateTo",
			title: "4. Schritt",
			content: "Geben Sie den Letzten Tag an.",
			placement: "bottom",
			btnNext: wtConfig.btnNext,
			btnBack: wtConfig.btnBack,
			onNext: function () {
		...
		},
		{
			...
			title: "5. Schritt",
			content: "Geben Sie das Mittagessen / Zeitmodell an.",
			placement: "bottom",
			btnNext: wtConfig.btnNext,
			btnBack: wtConfig.btnBack,
			onNext: function () {
